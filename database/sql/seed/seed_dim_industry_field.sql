...
\copy staging_industry_fields_temp(industry_field_code, industry_field_name) FROM '/home/andres/Desktop/7-semester/marketstat/server/database/datasets/dim_industry_field_dataset.csv' WITH (FORMAT CSV, HEADER TRUE, DELIMITER ',');
