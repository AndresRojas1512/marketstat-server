        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    is_etl_user = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    benchmark_history_id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    user_id = table.Column<int>(type: "integer", nullable: false),
                    benchmark_name = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    saved_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    filter_industry_field_id = table.Column<int>(type: "integer", nullable: true),
                    filter_standard_job_role_title = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    filter_hierarchy_level_name = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    filter_district_name = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    filter_oblast_name = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    filter_city_name = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    filter_date_start = table.Column<DateOnly>(type: "date", nullable: true),
                    filter_date_end = table.Column<DateOnly>(type: "date", nullable: true),
                    filter_target_percentile = table.Column<int>(type: "integer", nullable: true),
                    filter_granularity = table.Column<string>(type: "text", nullable: true),
                    filter_periods = table.Column<int>(type: "integer", nullable: true),
                    benchmark_result_json = table.Column<string>(type: "jsonb", nullable: false, defaultValue: "{}")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_benchmark_history", x => x.benchmark_history_id);
                    table.ForeignKey(
                        name: "fk_benchmark_history_user",
                        column: x => x.user_id,
                        principalSchema: "marketstat",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DimDateDbModelDateId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_fact_salaries", x => x.salary_fact_id);
                    table.ForeignKey(
                        name: "FK_fact_salaries_dim_date_DimDateDbModelDateId",
                        column: x => x.DimDateDbModelDateId,
                        principalSchema: "marketstat",
            ...
            migrationBuilder.CreateIndex(
                name: "idx_benchmark_history_saved_at",
                schema: "marketstat",
                table: "benchmark_history",
                column: "saved_at");

            migrationBuilder.CreateIndex(
                name: "idx_benchmark_history_user_id",
                schema: "marketstat",
                table: "benchmark_history",
                column: "user_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_fact_salaries_DimDateDbModelDateId",
                schema: "marketstat",
                table: "fact_salaries",
                column: "DimDateDbModelDateId");
