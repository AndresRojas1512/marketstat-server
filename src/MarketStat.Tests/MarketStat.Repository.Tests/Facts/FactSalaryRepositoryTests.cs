...
public class FactSalaryRepositoryTests
{
    ...
    private static FactSalaryRepository CreateRepository(MarketStatDbContext context)
    {
        return new FactSalaryRepository(context);
    }

    private static async Task SeedDimensionsAsync(MarketStatDbContext context)
    {
