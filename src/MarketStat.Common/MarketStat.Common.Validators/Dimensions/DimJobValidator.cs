...
{
    public static void ValidateForCreate(string jobRoleTitle, string standardJobRoleTitle, string hierarchyLevelName,
        int industryFieldId)
    {
    ...
    public static void ValidateForUpdate(int jobId, string jobRoleTitle, string standardJobRoleTitle,
