...
{
    Task<DimHierarchyLevel> CreateHierarchyLevelAsync(string hierarchyLevelName);
    Task<DimHierarchyLevel> GetHierarchyLevelByIdAsync(int id);
    Task<IEnumerable<DimHierarchyLevel>> GetAllHierarchyLevelsAsync();
    Task<DimHierarchyLevel> UpdateHierarchyLevelAsync(int hierarchyLevelId, string hierarchyLevelName);
